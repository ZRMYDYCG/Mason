...
import MenuLayoutSelector from './components/menu-layout-selector.vue'
import HeaderChromeSelector from './components/header-chrome-selector.vue'
import MenuThemeSelector from './components/menu-theme-selector.vue'
import MainColorSelector from './components/main-color-selector.vue'
import BoxStyleSelector from './components/box-style-selector.vue'
import ContainerWidthSelector from './components/container-width-selector.vue'
import BasicConfigPanel from './components/basic-config-panel.vue'
import DrawerShell from './components/drawer-shell.vue'
