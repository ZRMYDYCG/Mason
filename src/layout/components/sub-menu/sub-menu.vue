...
<style scoped>
:global(.aside .el-menu-item .icon),
:global(.aside .el-sub-menu__title .icon),
:global(.aside-popup-menu .el-menu-item .icon),
:global(.aside-popup-menu .el-sub-menu__title .icon) {
  margin-right: 8px;
  font-size: 18px;
