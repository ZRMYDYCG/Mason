...
let menus: RawMenu[] = [
  ...
  makeMenu(3, 'account-manage', '账号管理', '/system/account-manage', 2, 'users', 1),
  makeMenu(4, 'role-manage', '角色管理', '/system/role-manage', 2, 'shield-check', 2),
  makeMenu(5, 'menu-manage', '菜单管理', '/system/menu-manage', 2, 'menu', 3),
  makeMenu(6, 'department-manage', '部门管理', '/system/department-manage', 2, 'network', 4),
