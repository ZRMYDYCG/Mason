...
VALUES
  ...
  (
    27,
    'icon-picker',
    '/business-components/icon-picker',
    25,
    2,
    '图标选择器',
    '',
  ...
  (
    29,
    'image-crepping',
    '/business-components/image-cropping',
    25,
    3,
    '图片裁剪',
    '',
  ...
  (
    30,
    'form-generator',
    '/business-components/form-generator',
    25,
    4,
    '表单生成器',
    '',
  ...
  (
    34,
    'custom-table',
    '/basic-components/table/custom-table',
    32,
    1,
    '自定义表格',
    '',
  ...
  (
    35,
    'configurable-table',
    '/basic-components/table/configurable-table',
    32,
    1,
    '配置型表格',
    '',
  ...
  (
    36,
    'dynamic-form',
    '/basic-components/form/dynamic-form',
    33,
    1,
    '动态表单',
    '',
  ...
  (
    38,
    'step-form',
    '/basic-components/form/step-form',
    33,
    2,
    '分步表单',
    '',
  ...
  (
    51,
    'classify-list',
    '/basic-components/column/classify-list',
    39,
    1,
    '左分类右列表',
    '',
  ...
  (
    52,
    'tree-list',
    '/basic-components/column/tree-list',
    39,
    2,
    '左树右列表',
    '',
  ...
  (
    54,
    'flow-chart',
    '/business-components/flow chart',
    0,
    1,
    '流程图',
    '',
  ...
  (
    57,
    'video-conversation',
    '/business-components/video-conversation',
    25,
    3,
    '视频聊天',
    '',
  ...
  (
    59,
    'mason-pro-form',
    '/basic-components/mason-pro-form',
    31,
    5,
    '基础表单二次封装',
    '',
  ...
  (
    60,
    'mason-pro-input',
    '/basic-components/mason-pro-form/mason-pro-input',
    59,
    1,
    'mason-pro-input',
    '',
...
VALUES
  (
    ...
    'Mason',
    'Mason',
    '$2b$10$lNa7kr.QvhS8p1ZIMJfciOMgqEK0RPkj7L1W3Gz5uZVvx16j9T/2C',
    1,
    '547471919@qq.com',
    '15170536808',
    NULL,
  ...
  (
    ...
    '一勺',
    'Coder',
    '$2b$10$bdzkQNruFEncSkCjApsMleKg4au1/hyPDfQtvOdCa5VxSXlcltVD.',
    8,
    '547471919@qq.com',
    '15170536808',
    NULL,
