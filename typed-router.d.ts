...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/use-request-demo': RouteRecordInfo<
      ...
      Record<never, never>,
      Record<never, never>,
      '/use-request-demo/basic' | '/use-request-demo/effect' | '/use-request-demo/run'
    >
  ...
  export interface _RouteFileInfoMap {
    ...
    'src/pages/use-request-demo/basic.vue': {
      routes: '/use-request-demo/basic'
      views: never
    }
    'src/pages/use-request-demo/effect.vue': {
      routes: '/use-request-demo/effect'
      views: never
    }
    'src/pages/use-request-demo/run.vue': {
      routes: '/use-request-demo/run'
      views: never
    }
  }
